                        ...
                        <asp:UpdatePanel ID="UpdatePanelPromociones" runat="server">
                            ...
                            <ContentTemplate>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p class="DatosModal"><b>Está a punto de registrar una promoción, ¿Desea continuar?</b></p>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-outline-danger" data-bs-dismiss="modal">Cancelar</button>
                                                <asp:Button ID="btnGuardarAcusatorio" runat="server" CssClass="btn btn-outline-warning" OnClick="btnGuardarPromocion_Click" Text="Guardar" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <h2 class="textoTablasArriba"><i class="bi bi-table">Consulta de promociones</i></h2>
                                    ...
                                    <asp:GridView ID="GridViewPromociones" CssClass="table custom-gridview" runat="server" AutoGenerateColumns="False" OnRowCommand="GridViewPromociones_RowCommand" OnRowDataBound="GridViewPromociones_RowDataBound">
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:HiddenField ID="HiddenIdEjecucion" runat="server" Value='<%# Bind("IdEjecucion") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField>
                                                <HeaderStyle CssClass="bg-success text-white" />
                                                <ItemTemplate>
                                                    <asp:Button ID="btnVerDetalleCausa" runat="server" CommandName="VerDetalles" CommandArgument='<%# Eval("IdAsunto") %>' Text="Causa" CssClass="btn btn-secondary" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                                ...
                                <h2 class="textoTablasArriba"><i class="bi bi-table">Causas Relacionadas</i></h2>
                                    </asp:Label>
