...
namespace SIPOH
{
    public partial class ConsignacionesHistorica : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //bool tienePermiso = enlaces.Any(enlace => enlace.Contains("/consignacionesHistorica"));
            bool tienePermiso = enlaces != null ? enlaces.Any(enlace => enlace.Contains("/consignacionesHistorica")) : false;
