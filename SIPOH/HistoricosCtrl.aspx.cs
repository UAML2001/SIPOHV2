...
namespace SIPOH
{
    public partial class HistoricosCtrl : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //bool tienePermiso = enlaces.Any(enlace => enlace.Contains("/historicosCtrl"));
            bool tienePermiso = enlaces != null ? enlaces.Any(enlace => enlace.Contains("/historicosCtrl")) : false;
