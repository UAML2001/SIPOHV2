...
namespace SIPOH
{
    public partial class SolicitudCDs : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //bool tienePermiso = enlaces.Any(enlace => enlace.Contains("/solicitudCDs"));
            bool tienePermiso = enlaces != null ? enlaces.Any(enlace => enlace.Contains("/solicitudCDs")) : false;
