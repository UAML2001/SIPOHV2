<%@ Page Title="" Language="C#" MasterPageFile="~/Consignacion.Master" AutoEventWireup="true" CodeBehind="Iniciales.aspx.cs" Inherits="SIPOH.Iniciales" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentEIniciales" runat="server">
    <div class="container">
        ...
        <div>
            <h1 style="margin-left: 5%" class="h5">Iniciales <i class="fas fa-angle-right"></i><span id="dataSplash" class="text-success fw-bold">Iniciales</span> </h1>
        </div>
        <div class="m-0">
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-tabs justify-content-center" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active  onSplash" data-toggle="tab" href="#IAcusatorio" role="tab">Sistema Acusatorio
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link  onSplash" data-toggle="tab" href="#ITradicional" role="tab">Sistema Tradicional
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content ">
                                ...
                                <div class="tab-pane" id="ITradicional" role="tabpanel">
                                    <%@ Register Src="~/Views/InicialTradicional.ascx" TagPrefix="uc1" TagName="InicialTradicional" %>
