    ...
    <ContentTemplate>
        ...
        <div class="row" id="primerRowTradicional" runat="server">
            <div class="mb-5 col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-4">
                ...
                <asp:DropDownList ID="InDistritoTra" runat="server" CssClass="form-select form-select-sm mayusculas" AutoPostBack="true" OnSelectedIndexChanged="InDistritoTra_SelectedIndexChanged">
                    <asp:ListItem Value="0">Seleccionar</asp:ListItem>
                </asp:DropDownList>
            </div>
            <div class="mb-5 col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-4">
                <label class="form-label text-secondary">Juzgado de Procedencia</label>
                <asp:DropDownList ID="InJuzgadoProcedenciaTra" runat="server" CssClass="form-select form-select-sm mayusculas">
            ...
            <div class="mb-5 col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-4">
                ...
                <div class="input-group">
                    <input type="text" class="form-control form-control-sm mayusculas" id="InCausaTra" runat="server" maxlength="9" onblur="padLeadingZeros(this)" placeholder="">
        ...
        <div class="container" id="OcultarTradicional" runat="server">
            ...
            <div class="row">
                <div class="mb-5 col-12 col-sm-6 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
                    ...
                    <asp:DropDownList ID="selectSalasTradicional" runat="server" CssClass="form-select form-select-sm mayusculas">
                ...
                <div class="mb-5 col-12 col-sm-6 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
                    ...
                    <div class="input-group">
                        <asp:TextBox ID="inputNumeroTocaTradicional" runat="server" CssClass="form-control form-control-sm mayusculas" placeholder="" onblur="padLeadingZeros(this)"></asp:TextBox>
                        <div class="input-group-append">
                ...
                <div class="mb-5 col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                    ...
                    <div class="input-group">
                        <asp:TextBox ID="inputSentenciaTradicional" runat="server" CssClass="form-control form-control-sm mayusculas" placeholder="Busca Sentencia"></asp:TextBox>
                        <div class="input-group-append">
        ...
        <div class="container" id="RegistroPartesInTradicional" runat="server">
            <div class="row">
                <div class="mb-5 col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-4">
                    ...
                    <input type="text" id="InputNombreBusquedaTradicional" class="form-control form-control-sm mayusculas" placeholder="" runat="server" />
                </div>
                <div class="mb-5 col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-4">
                    <label for="InputApPaternoBusquedaTradicional" class="form-label text-secondary">Ap. Paterno Parte</label>
                    <input type="text" id="InputApPaternoBusquedaTradicional" class="form-control form-control-sm mayusculas" placeholder="" runat="server" />
                </div>
                <div class="mb-5 col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-4">
                    <label for="inputApMaternoTradicional" class="form-label text-secondary">Ap. Materno de Causa</label>
                    <div class="input-group">
                        <input type="text" id="inputApMaternoTradicional" class="form-control form-control-sm mayusculas" placeholder="" runat="server">
                        <div class="input-group-append">
            ...
            <div id="ContinuarRegistroTradicional" runat="server">
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <asp:DropDownList ID="CatSolicitantesDDTradicional" runat="server" CssClass="form-select form-select-sm mayusculas">
                            <asp:ListItem Text="Seleccionar" />
                        </asp:DropDownList>
                    </div>
                    <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                        ...
                        <asp:DropDownList ID="CatSolicitudDDTradicional" runat="server" AutoPostBack="true" OnSelectedIndexChanged="CatSolicitudDDTradicional_SelectedIndexChanged" CssClass="form-select form-select-sm mayusculas">
                            <asp:ListItem Text="Seleccionar" />
                        </asp:DropDownList>
                    </div>
                    <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                        ...
                        <asp:DropDownList ID="CatAnexosDDTradicional" runat="server" CssClass="form-select form-select-sm mayusculas" AutoPostBack="true" OnSelectedIndexChanged="CatAnexosDDTradicional_SelectedIndexChanged">
                            <asp:ListItem Text="Seleccionar" />
                        </asp:DropDownList>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                        ...
                        <input type="text" id="OtroAnexoTradicional" class="form-control form-control-sm mayusculas" runat="server" clientidmode="Static" />
                    </div>
                    <div class="mb-5 col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-4">
                        <label for="inputNuc" class="form-label text-secondary">Cantidad</label>
                        <div class="input-group">
                            <input type="number" id="CantidadInputTradicional" class="form-control form-control-sm mayusculas" runat="server" clientidmode="Static">
                            <div class="input-group-append">
