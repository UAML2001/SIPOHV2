<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HistoricosCupre.ascx.cs" Inherits="SIPOH.Views.HistoricosCupre" %>

<div class="container col-12">
    <div style="text-align: center; padding: 3%">
        <h3>Registrar Cupre</h3>
    </div>
    ...
    <div class="row ">
        ...
        <div class="col-md-3 col-sm-3 col-xs-3">
            <h6 class="help-block text-muted small-font" id="">Especificar Nombre: </h6>
