...
<script type="text/javascript">
    ...
    function validarNumero(input) {
        ...
        if (isNaN(valor)) {
            var mensaje = "Este campo solo acepta nùmeros";
            toastError(mensaje);
            input.value = "";
        }
    }
        ...
        <div class=" px-2 mx-1">
            <div class="row d-flex justify-content-end align-content-end">
                ...
                <div class="mb-4 col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl-3">
                    <h6 class="help-block text-muted small-font">Número de
            <asp:Label ID="itemNombre" runat="server" Text=""></asp:Label>: </h6>
                    ...
                    <div class="card-body">
                        ...
                        <div class="">
                            <div class="d-flex justify-content-end">
                                ...
                                <h5 class="text-success text-right">Relación de partes</h5>
                            </div>
                            <br />
                            <br />
                            <%-- First part --%>
                            ...
                            <%-- third part --%>
                             <div class="row mb-4 pt-3 " style="background-color: #3F5259;">
                                 <div class="mb-2 col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 col-xxl-3">
                                    <h6><b class="text-success">Número de amparo:</b></h6>
