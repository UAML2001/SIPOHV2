...
<div class="row">
        <div class="mb-5 col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-4">
            <label for="inputRadicacion" class="form-label text-secondary">Nombre(s) Beneficiario</label>
            <input type="text" class="form-control" placeholder="" />
        </div>
        <div class="mb-5 col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-4">
            <label for="inputIncomJuzgado" class="form-label text-secondary">Apellido Paterno</label>
            <input type="text" class="form-control" placeholder="" />
        </div>
        <div class="mb-5 col-12 col-sm-6 col-md-6 col-lg-4 col-xl-4 col-xxl-4">
            <label for="inputNuc" class="form-label text-secondary">Apellido Materno</label>
            <div class="input-group">
                <input type="text" class="form-control" id="inputNuc" placeholder="">
