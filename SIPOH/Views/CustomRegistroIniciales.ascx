                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body row">
                        <div class="col-6 pb-2">
                            <span class="text-secondary">Numero de NUC:</span>
                        ...
                        <div class="col-6 pb-2">
                            <span class="text-secondary">Fecha de recepcion:</span>
                        ...
                        <div class="col-6 pb-2">
                            <span class="text-secondary">Nombre de quien Ingresa:</span>
                        ...
                        <div class="col-6 pb-2">
                            <span class="text-secondary">Tipo de Radicacion:</span>
