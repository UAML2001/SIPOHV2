...
namespace SIPOH
{
    public partial class ReportesCtrl : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //bool tienePermiso = enlaces.Any(enlace => enlace.Contains("/reportesCtrl"));
            bool tienePermiso = enlaces != null ? enlaces.Any(enlace => enlace.Contains("/reportesCtrl")) : false;
