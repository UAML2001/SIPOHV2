                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="container col-12">
                                <div style="padding: 2%">
                                    <h5 class="text-secondary mb-5">Digitalizar Posteriores</h5>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="scrollable">
                                        <asp:GridView ID="PDigitalizar" CssClass="table" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="3" OnPageIndexChanging="PDigitalizar_PageIndexChanging">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="TipoPromocion" HeaderText="Tipo de Posterior" HeaderStyle-CssClass="bg-success text-white" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" />
                                    ...
                                    <div class="row ">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <asp:Label ID="lblInicialInfo" runat="server" CssClass="help-block text-muted small-font" Visible="false"><b>Informacion de la posterior: </b></asp:Label>
                                            <br />
                                            <br />
                                    ...
                                    <div class="row ">
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            ...
                                            <asp:Label ID="lblinfo" runat="server" CssClass="help-block text-muted small-font" Style="text-align:justify" Visible="false"><b>(*) Los elementos seleccionados estan en estatus "NO DIGITALIZADOS", quite la seleccion si el anexo ya esta digitalizado.</b></asp:Label>
                                                ...
                                                <br />
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <asp:Label ID="lblAdjuntar" runat="server" CssClass="help-block text-muted small-font" Visible="false">
                                            <b>Adjuntar documentos:</b>
                                            </asp:Label>
                                            <br />
                                            <br />
                                        ...
                                        <center>
                                        <div class="col-md-3 col-sm-3 col-xs-3" padding: 10px;">
                                            <asp:Button ID="btnDigitalizar" Visible="false" runat="server" Text="Digitalizar" CssClass="btn btn-success btn-sm mayusculas" />
                                        </div>
                                        </center>
                                    </div>
                                </div>
