...
<div>
   ...
   <script>
    ...
    </asp:Content><%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Consignacion.Master" CodeBehind="DigitalizarPosteriores.aspx.cs" Inherits="SIPOH.DigitalizarPosteriores" %>

<%@ Register Assembly="CrystalDecisions.Web, Version=13.0.4000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" Namespace="CrystalDecisions.Web" TagPrefix="CR" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentDigitInici" runat="server">
                   ...
                   <div class="card-body">
                       <div class="container col-12">
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12">
                               ...
                               <br />
                               <div class="scrollable">
                                <asp:GridView ID="GridView1" CssClass="table table-striped text-center table-hover table-sm" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="3" OnPageIndexChanging="PDigitalizar_PageIndexChanging">
                                    <Columns>
                                        <asp:TemplateField HeaderStyle-CssClass="bg-success text-white">
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chkSelect" runat="server" AutoPostBack="True" OnCheckedChanged="chkSelect_CheckedChanged" />
                                    ...
                                    <PagerTemplate>
                                        <asp:Button ID="btnFirst" CssClass="btn btn-outline-primary" runat="server" CommandName="Page" CommandArgument="First" Text=" Primero" />
                                        <asp:Button ID="btnPrev" CssClass="btn btn-outline-success" runat="server" CommandName="Page" CommandArgument="Prev" Text="⏮️ Anterior" />
                                        <asp:Button ID="btnNext" CssClass="btn btn-outline-success" runat="server" CommandName="Page" CommandArgument="Next" Text="⏭️ Siguiente" />
                                        <asp:Button ID="btnLast" CssClass="btn btn-outline-primary" runat="server" CommandName="Page" CommandArgument="Last" Text=" Ultimo" />
                                    </PagerTemplate>
                                </asp:GridView>
                               ...
                               <div class="row ">
                                   <div class="col-md-12 col-sm-12 col-xs-12">
                                       <asp:Label ID="Label1" runat="server" CssClass="help-block text-muted small-font" Visible="false"><b>Informacion de la inicial: </b></asp:Label>
                                       <br />
                                       <br />
                               ...
                               <div class="row">
                                   <div class="mb-0 col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                       ...
                                       <br />
                                       <asp:GridView ID="GridView2" CssClass="table table-borderless d-sm-table-row" GridLines="None" runat="server" AutoGenerateColumns="False" ShowHeader="False">
                                           <Columns>
                                               <asp:TemplateField>
                                                   <ItemTemplate>
                                                       <div style="font-size: larger; font-weight: bold; font-style: italic;">
                                   ...
                                   <div class="mb-0 col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                                       ...
                                       <br />
                                       <asp:GridView ID="GridView3" CssClass="table table-borderless d-sm-table-row" GridLines="None" runat="server" AutoGenerateColumns="False" ShowHeader="False">
                                           <Columns>
                                               <asp:TemplateField>
                                                   <ItemTemplate>
                                                       <div style="font-size: larger; font-weight: bold; font-style: italic;">
                               ...
                               <div class="row ">
                                   <div class="col-md-6 col-sm-6 col-xs-6">
                                       <asp:Label ID="Label7" runat="server" CssClass="help-block text-muted small-font" Visible="false"><b>*Documentos no digitalizados:</b></asp:Label>
                                       <br />
                                       <br />
                                       <asp:GridView ID="GridView4" CssClass="table table-striped text-center table-hover table-sm" runat="server" AutoGenerateColumns="False">
                                           <Columns>
                                               <asp:TemplateField HeaderStyle-CssClass="bg-success text-white">
                                                   <ItemTemplate>
                                                       <asp:CheckBox ID="chkSelect" runat="server" AutoPostBack="False" Checked='<%# Eval("Digitalizado").ToString() == "N" %>' />
                                       ...
                                       <asp:Label ID="Label8" runat="server" CssClass="help-block text-muted small-font" Style="text-align: justify" Visible="false"><b>(*) Los elementos seleccionados estan en estatus "NO DIGITALIZADOS", quite la seleccion si el anexo ya esta digitalizado.</b></asp:Label>
                                       <br />
                                       <br />
                                       <br />
                                   </div>
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-6">
                                       <asp:Label ID="Label9" runat="server" CssClass="help-block text-muted small-font" Visible="false"><b>Adjuntar documentos:</b>
                                       </asp:Label>
                                       <br />
                                       <br />

                                       <div style="margin-bottom: 10px;">
                                           <asp:FileUpload ID="FileUpload1" Visible="false" runat="server" CssClass="form-control" accept=".pdf" />
                                       </div>
                                       <div>
                                           <asp:Label ID="Label10" runat="server" CssClass="help-block text-muted small-font" Style="display: none"><b>Vista previa del documento adjunto:</b>
                                           </asp:Label>
                                           <br />
                                           <asp:Panel runat="server" ID="Panel1" Style="margin: auto; max-height: 50%; overflow-y: auto;"></asp:Panel>
                                           <br />
                                       </div>
                                   </div>
                                    ...
                                    <center>
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12" style="padding: 10px;">
                                                <%--<asp:Button ID="btnImpresionPort" Visible="true" runat="server" Text="🖨️ Imprimir Portada" CssClass="btn btn-success btn-sm mayusculas" />--%>
                                                <asp:Button ID="Button1" Visible="false" runat="server" Text="💻 Digitalizar" CssClass="btn btn-outline-success btn-sm mayusculas" OnClick="btnDigitalizar_Click" />
