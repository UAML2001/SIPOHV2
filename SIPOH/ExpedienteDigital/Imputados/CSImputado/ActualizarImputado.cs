...
{
    public void UpdateImputData(int idAsunto, int idPartes, string apPaterno, string apMaterno, string nombre, string genero, string tipoParte, string rfc, string curp, string edad, DateTime feNacimiento, string aliasImp, int idContNacido, int idPaisNacido,
            ...
            Page page, int idEstadoPsi, int idaccipenal, int idReinci, int idTipoDeten, int idOrdenJudi, int idCondFamiliar, int depEcon, int idSustancias)
    {
        ...
        SET
            [CURP] = @CURP, [RFC] = @RFC, [Edad] = @Edad, [FeNacimiento] = @FeNacimiento, [IdNacionalidad] = @IdNacionalidad,
