...
public class ActualizarVictima
{
    public void UpdateVictimData(
        ...
        string idMunicipioNacido, int idNacionalidad, int idCondicion, int idEstadoCivil, int idGradoEstudios, int idLengExtra, int idRelacImput,
        int idAlfabet, int idiomaEspañol, int idVulnerabilidad, int idAsisMigra, int idPueblo, int hablaIndigena, int idDialecto, int idOcupacion, int idProfesion, string domOcupacion,
