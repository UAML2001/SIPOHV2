...
{
        public void MostrarCedula(int idAsunto, int idPartes, string apPaterno, string apMaterno, string nombre, string genero, string tipoParte, string rfc, string curp, string edad, DateTime feNacimiento, int idContNacido, int idPaisNacido,
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand cmd = new SqlCommand("LlenarCedulaVictima", conn))
                {
                    ...
                    reporte.Export();
                        ...
                        ((ExpeDigital)page).MostrarCedula("~/ExpedienteDigital/Victimas/CedulaVictimas.pdf");
