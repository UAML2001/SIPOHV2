...
public class InsertarVictima
{
    public void InsertVictimData(
            ...
            string idMunicipioNacido, int idNacionalidad, int idCondicion, int idEstadoCivil, int idGradoEstudios, int idLengExtra, int idRelacImput, int idAlfabet, int idiomaEspañol,
