...
<div class="row">
    ...
    <asp:GridView ID="GridViewPCausa4" CssClass="table custom-gridview" runat="server" OnRowCommand="GridViewPCausa4_RowCommand" OnRowDataBound="GridViewPCausa4_RowDataBound" AutoGenerateColumns="False" AllowPaging="True" PageSize="5" OnPageIndexChanging="GridViewPCausa4_PageIndexChanging">
 <Columns>
       ...
       <asp:BoundField DataField="Proviene" HeaderText="Proviene">
        ...
        <asp:TemplateField>
            <HeaderStyle CssClass="bg-success text-white" />
            <ItemTemplate>
                <asp:Button ID="btnVerDetalles4" runat="server" CommandName="VerDetalles" CommandArgument='<%# Eval("IdEjecucion") %>' Text="Ver" CssClass="btn btn-secondary" />
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
</asp:GridView>
