<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginExterno.aspx.cs" Inherits="SIPOH.Externo.LoginExterno" %>
...
<body>
    ...
    <form id="form1" runat="server" class="background-form pt-5 ">
                            ...
                            <div class="form-group d-flex flex-column mt-4">
                                ...
                                <div class="input-group mb-2">
                                    <asp:TextBox ID="txtPass" runat="server" CssClass="form-control form-control-sm"
                                        TextMode="Password" Width="100%" BorderColor="Gray" Text=""></asp:TextBox>
                                ...
                                <asp:HyperLink ID="hyperlink3" NavigateUrl="RegistroExterno.aspx"
                                    Text="Crear cuenta" runat="server" />
                            </div>

                            <div class="col-12 my-4">
                                <asp:Button ID="BtnEntrar" runat="server" Text="ACCEDER" CssClass="Boton"
                                    OnClientClick="firmaLogeo(); return false;" Style="height: 50px; width: 50%; font-family: Arial Black; font-size: 16px;" />
                                                               
                                <asp:Button runat="server" ID="btnIngresar" Text="Generar" Style="display: none;" OnClick="btnIngresar_Click" />
                                <%--                                <asp:Button ID="Button1" runat="server" OnClientClick="Url()" Style="display: none;" OnClick="Button1_Click" Text="Button" />--%>
                            </div>
                        </div>
        ...
        <br />
                                    ...
                                    <asp:HiddenField ID="HFCURP" runat="server" />
                            <asp:HiddenField ID="HFIdUsuarioExterno" runat="server" />
