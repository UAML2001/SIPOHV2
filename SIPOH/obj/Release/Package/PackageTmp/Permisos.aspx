                    ...
                    <div class="col-md-12 col-md-12 ml-auto col-xl-12 mr-auto">
                        ...
                        <div class="card ">
                            <div class="card-header bg-white">
                                ...
                                <asp:TextBox runat="server" ID="txtbxPerfilSelected" CssClass="form-control form-control-sm text-danger" MaxLength="30" />
                                <asp:Label ID="lblIdSeleccionado" runat="server" Text="" CssClass="text-white"></asp:Label>
...
<asp:UpdatePanel runat="server" ID="PanelPermisos" ChildrenAsTriggers="true" UpdateMode="Conditional">
    <ContentTemplate>
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content bg-white">
                ...
                <div class="modal-body">
                            <div class="d-flex justify-content-end align-content-center mx-1">
                                <span class="small mx-2 align-self-center">Permisos <b>no</b> asociados:</span>
                                <div class="col-auto">

                                    <asp:DropDownList runat="server" ID="CatEnlacesNoAsignados" AutoPostBack="false" CssClass="form-select form-select-sm text-secondary col-auto mx-1" AppendDataBoundItems="false">
                                        <asp:ListItem Text="Selecciona una opción" Value="0" Selected="True" />
                                    </asp:DropDownList>
                                    <%-- </ContentTemplate>
    </asp:UpdatePanel>--%>
                                </div>
                                <i class=" bi bi-caret-down-fill btn btn-sm btn-outline-success col-auto" data-bs-toggle="collapse" data-bs-target="#ConteniodSubpermisosAsociados" aria-expanded="false" aria-controls="ConteniodSubpermisosAsociados"></i>

                            </div>
                            <%-- <asp:CheckBox ID="chkExample" runat="server" Text=" " />
                                    <span class="float-end">VER</span>--%>
                            <%--<asp:CheckBox ID="chkExample" runat="server" Text=" "  />
                                            <span class="float-end px-2"> Ver</span>--%>

                            <div class="collapse" id="ConteniodSubpermisosAsociados">
                                <div class="collapse d-flex bg-light border p-3 mt-3 ">
                                    <div class="p-2 flex-fill">
                                        <span class="fw-bold text-dark">Tipo de usuario:</span>
                                        <asp:DropDownList runat="server" ID="TipoUsuario" AutoPostBack="false" CssClass="form-select form-select-sm text-secondary col-4 mx-1" AppendDataBoundItems="false">
                                            <asp:ListItem Text="Selecciona una opción" Value="0" Selected="True" />
                                        </asp:DropDownList>

                                    </div>
                                    <div class="p-2 flex-fill">
                                        <span class="fw-bold text-dark">Permisos de enlace:</span>
                                        <asp:Repeater ID="RepeaterPermiosEnlace" runat="server">
                                            <ItemTemplate>
                                                <div class="rounded border-bottom pb-1 mb-1 clearfix">
                                                    <asp:CheckBox ID="chkExample" runat="server" Text=" " data-IdTipoPermiso='<%# Eval("IdTipoPermisoUsuario") %>' />
                                                    <span class=" px-2 text-center"><%# Eval("TipoPermisoUsuario") %></span>
                                                    <i class="<%# Eval("iconoPermiso") %> float-end"></i>
                                                </div>
                                            </ItemTemplate>
                                        </asp:Repeater>

                                        <div class="d-flex justify-content-left align-content-center mt-4">
                                            <asp:Button CssClass="btn btn-sm btn-success mx-2" runat="server" ID="Button1" Text="Añadir ➕" OnClick="btnAsignarSubPermisosAsociados_Click" />
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="">
                                                    <div class="form-check form-switch">
                                                        <asp:CheckBox ID="chkPermisoAsociado" runat="server" Text=" " data-PermisoAsociado='<%# Eval("Ver") %>' Checked='<%# Convert.ToBoolean(Eval("Ver")) %>' />
                                                ...
                                                <td class="">
                                                    <div class="form-check form-switch">
                                                        <asp:CheckBox ID="CheckBox1" runat="server" Text=" " data-PermisoAsociado='<%# Eval("Editar") %>'  Checked='<%# Convert.ToBoolean(Eval("Editar")) %>' />
                                                ...
                                                <td class="">
                                                    <div class="form-check form-switch">
                                                        <asp:CheckBox ID="CheckBox2" runat="server" Text=" " data-PermisoAsociado='<%# Eval("Eliminar") %>'  Checked='<%# Convert.ToBoolean(Eval("Eliminar")) %>' />
                                                ...
                                                <td class="">
                                                    <div class="form-check form-switch">
                                                        <asp:CheckBox ID="CheckBox3" runat="server" Text=" " data-PermisoAsociado='<%# Eval("SuperUser") %>'  Checked='<%# Convert.ToBoolean(Eval("SuperUser")) %>' />
                                                ...
                                                <td class="">
                                                    <div class="form-check form-switch">
                                                        <asp:CheckBox ID="CheckBox4" runat="server" Text=" " data-PermisoAsociado='<%# Eval("Administrador") %>'  Checked='<%# Convert.ToBoolean(Eval("Administrador")) %>' />
                                                ...
                                                <td class="">
                                                    <div class="form-check form-switch">
                                                        <asp:CheckBox ID="CheckBox5" runat="server" Text=" " data-PermisoAsociado='<%# Eval("Usuario") %>'  Checked='<%# Convert.ToBoolean(Eval("Usuario")) %>' />
                                    ...
                                    <asp:Repeater ID="RepeaterGetSubpermisoAsociadoControl" runat="server">
                                        <ItemTemplate>
                                            ...
                                            <tr>
                                                ...
                                                <td class="">
                                                    <div class="form-check form-switch">
                                                        <asp:CheckBox ID="CheckBox1" runat="server" Text=" " data-PermisoAsociado='<%# Eval("Ver") %>'  Checked='<%# Convert.ToBoolean(Eval("Ver")) %>' />
                                                        <label class='<%# Convert.ToBoolean(Eval("Ver")) ? "form-check-label text-success" : "form-check-label text-secondary" %>' for="flexSwitchCheckCrear"><%# Eval("Ver") %></label>
                                                    </div>
                                                </td>
                                                <td class="">
                                                    <div class="form-check form-switch">
                                                        <asp:CheckBox ID="CheckBox6" runat="server" Text=" " data-PermisoAsociado='<%# Eval("Editar") %>'  Checked='<%# Convert.ToBoolean(Eval("Editar")) %>' />
                                                        <label class='<%# Convert.ToBoolean(Eval("Editar")) ? "form-check-label text-success" : "form-check-label text-secondary" %>' for="flexSwitchCheckVer"><%# Eval("Editar") %></label>
                                                    </div>
                                                </td>
                                                <td class="">
                                                    <div class="form-check form-switch">
                                                        <asp:CheckBox ID="CheckBox7" runat="server" Text=" " data-PermisoAsociado='<%# Eval("Eliminar") %>'  Checked='<%# Convert.ToBoolean(Eval("Eliminar")) %>' />
                                                        <label class='<%# Convert.ToBoolean(Eval("Eliminar")) ? "form-check-label text-success" : "form-check-label text-secondary" %>' for="flexSwitchCheckActualizar"><%# Eval("Eliminar") %></label>
                                                    </div>
                                                </td>
                                                <td class="">
                                                    <div class="form-check form-switch">
                                                        <asp:CheckBox ID="CheckBox8" runat="server" Text=" " data-PermisoAsociado='<%# Eval("SuperUser") %>'  Checked='<%# Convert.ToBoolean(Eval("SuperUser")) %>' />
                                                        <label class='<%# Convert.ToBoolean(Eval("SuperUser")) ? "form-check-label text-success" : "form-check-label text-secondary" %>' for="flexSwitchCheckEliminar"><%# Eval("SuperUser") %></label>
                                                    </div>
                                                </td>
                                                <td class="">
                                                    <div class="form-check form-switch">
                                                        <asp:CheckBox ID="CheckBox9" runat="server" Text=" " data-PermisoAsociado='<%# Eval("Administrador") %>'  Checked='<%# Convert.ToBoolean(Eval("Administrador")) %>' />
                                                        <label class='<%# Convert.ToBoolean(Eval("Administrador")) ? "form-check-label text-success" : "form-check-label text-secondary" %>' for="flexSwitchCheckEliminar"><%# Eval("Administrador") %></label>
                                                    </div>
                                                </td>
                                                <td class="">
                                                    <div class="form-check form-switch">
                                                        <asp:CheckBox ID="CheckBox10" runat="server" Text=" " data-PermisoAsociado='<%# Eval("Usuario") %>'  Checked='<%# Convert.ToBoolean(Eval("Usuario")) %>' />
                                                        <label class='<%# Convert.ToBoolean(Eval("Usuario")) ? "form-check-label text-success" : "form-check-label text-secondary" %>' for="flexSwitchCheckEliminar"><%# Eval("Usuario") %></label>
                                                    </div>
                                                </td>
                                            </tr>
                                    ...
                                    <asp:Repeater ID="RepeaterGetSubpermisoAsociadoEjecucion" runat="server">
                                        <ItemTemplate>
                                            ...
                                            <tr>
                                                ...
                                                <td class="">
                                                    <div class="form-check form-switch">
                                                        <asp:CheckBox ID="CheckBox11" runat="server" Text=" " data-PermisoAsociado='<%# Eval("Editar") %>'  Checked='<%# Convert.ToBoolean(Eval("Editar")) %>' />
                                                        <label class='<%# Convert.ToBoolean(Eval("Editar")) ? "form-check-label text-success" : "form-check-label text-secondary" %>' for="flexSwitchCheckVer"><%# Eval("Editar") %></label>
                                                    </div>
                                                </td>
                                                <td class="">
                                                    <div class="form-check form-switch">
                                                        <asp:CheckBox ID="CheckBox12" runat="server" Text=" " data-PermisoAsociado='<%# Eval("Eliminar") %>'  Checked='<%# Convert.ToBoolean(Eval("Eliminar")) %>' />
                                                        <label class='<%# Convert.ToBoolean(Eval("Eliminar")) ? "form-check-label text-success" : "form-check-label text-secondary" %>' for="flexSwitchCheckActualizar"><%# Eval("Eliminar") %></label>
                                                    </div>
                                                </td>
                                                <td class="">
                                                    <div class="form-check form-switch">
                                                        <asp:CheckBox ID="CheckBox13" runat="server" Text=" " data-PermisoAsociado='<%# Eval("SuperUser") %>'  Checked='<%# Convert.ToBoolean(Eval("SuperUser")) %>' />
                                                        <label class='<%# Convert.ToBoolean(Eval("SuperUser")) ? "form-check-label text-success" : "form-check-label text-secondary" %>' for="flexSwitchCheckEliminar"><%# Eval("SuperUser") %></label>
                                                    </div>
                                                </td>
                                                <td class="">
                                                    <div class="form-check form-switch">
                                                        <asp:CheckBox ID="CheckBox14" runat="server" Text=" " data-PermisoAsociado='<%# Eval("Administrador") %>'  Checked='<%# Convert.ToBoolean(Eval("Administrador")) %>' />
                                                        <label class='<%# Convert.ToBoolean(Eval("Administrador")) ? "form-check-label text-success" : "form-check-label text-secondary" %>' for="flexSwitchCheckEliminar"><%# Eval("Administrador") %></label>
                                                    </div>
                                                </td>
                                                <td class="">
                                                    <div class="form-check form-switch">
                                                        <asp:CheckBox ID="CheckBox15" runat="server" Text=" " data-PermisoAsociado='<%# Eval("Usuario") %>'  Checked='<%# Convert.ToBoolean(Eval("Usuario")) %>' />
                                                        <label class='<%# Convert.ToBoolean(Eval("Usuario")) ? "form-check-label text-success" : "form-check-label text-secondary" %>' for="flexSwitchCheckEliminar"><%# Eval("Usuario") %></label>
                                                    </div>
                                                </td>
                                            </tr>
