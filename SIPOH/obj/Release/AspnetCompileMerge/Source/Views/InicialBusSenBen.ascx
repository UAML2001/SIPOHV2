...
<div class="container">
    <div class="row">
        <div class="col-sm-6 col-md-4">
            ...
            <input type="text" class="form-control form-control-sm mayusculas" id="inputNombreBeneficiario2" maxlength="250" runat="server" />
        </div>
        <div class="col-sm-6 col-md-3">
            <label for="inputApellidoPaterno2" class="form-label text-secondary">Apellido Paterno</label>
            <input type="text" class="form-control form-control-sm mayusculas" id="inputApellidoPaterno2" maxlength="100" runat="server" />
        </div>
        <div class="col-sm-6 col-md-3">
            <label for="inputApellidoMaterno2" class="form-label text-secondary">Apellido Materno</label>
            <input type="text" class="form-control form-control-sm mayusculas" id="inputApellidoMaterno2" maxlength="100" runat="server" />
        </div>
