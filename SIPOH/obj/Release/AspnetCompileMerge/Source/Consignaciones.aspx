...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentCausa" runat="server">
    ...
    <div class="d-flex justify-content-between px-3 mb-4">
        <span class="text-sm">Consignaciones <i class="fas fa-angle-right"></i><span id="dataSplash" class="text-success fw-bold ">Registro de iniciales</span> </span>
        <b>Registro</b>
    </div>
        ...
        <div class="card">
            <div class="card-header">
                <ul class="nav nav-tabs justify-content-center" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active   onSplash" data-toggle="tab" href="#registroIniciales" role="tab">Registro de iniciales
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link onSplash" data-toggle="tab" href="#exhorto" role="tab">Exhorto
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link onSplash" data-toggle="tab" href="#juciooral" role="tab">Juicio Oral
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  onSplash" data-toggle="tab" href="#amparo" role="tab">Amparo
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="card-body mx-3  p-0">
                ...
                <div class="tab-content ">
                    ...
                    <div class="tab-pane active" id="registroIniciales" role="tabpanel">
                    ...
                    <div class="tab-pane" id="amparo" role="tabpanel">
                        <%--Importacion de Controles--%>
