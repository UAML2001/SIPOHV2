...
namespace SIPOH
{
    public partial class Estadistica : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //bool tienePermiso = enlaces.Any(enlace => enlace.Contains("/estadistica"));
            bool tienePermiso = enlaces != null ? enlaces.Any(enlace => enlace.Contains("/estadistica")) : false;
            ...
            if ((circuito == "c" || circuito == "d" || circuito == "e") && tienePermiso)
            {
                Visible = true;
            }
            else
